...
//$page_header .= "<link rel='stylesheet' type='text/css' href='./styling/document_style.css' />";
$page_header .= "<?php header('Content-Type: text/html; charset=utf-8' ); ?>";
...
$result = mysql_query("select * from tbl_admin_tasks;");
$page_right_menu .= "<tr><td><br/></td></tr><tr><td class='right_menu'>Admin Tasks:</td></tr>";
while($row=mysql_fetch_array($result))
{$page_right_menu .= "<tr><td class='right_menu'> <a href='".$row[2]."' class='right_menu'> ".$row[1]." </a> </td></tr>"; }
mysql_close($con); 
...
$page_footer =" </td></tr><tr><td class='footer' text-align='center'colspan='2'> <a class='right_menu' href='./admin_logged_out.php'> admin logout </a> </td></tr></table>";
