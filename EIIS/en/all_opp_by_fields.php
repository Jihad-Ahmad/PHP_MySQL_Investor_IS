...
$menu ="<br/><br/><ul><h3> Investment Fields Opportunities</h3><p>";
...
$menu .= "<li><a class='right_menu' href='display_info_field_opp.php?q=".$this_field[2]."'> <img src='".$this_field[1]."' width='30px' height='30px' />Opportunities in  ".$this_field[2]."</a></li>";
    }
